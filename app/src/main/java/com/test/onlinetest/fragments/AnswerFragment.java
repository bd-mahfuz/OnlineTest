...
public class AnswerFragment extends Fragment implements View.OnClickListener{
    ...
    public void initView(View view) {
        ...
        mQuestionRg = view.findViewById(R.id.sQuestionRg);
        option1RB = view.findViewById(R.id.aOption1);
        option2RB = view.findViewById(R.id.aOption2);
        option3RB = view.findViewById(R.id.aOption3);
        option4RB = view.findViewById(R.id.aOption4);

        mNextBtn = view.findViewById(R.id.nextBtn);
        mPreviousBtn = view.findViewById(R.id.previousBtn);

        mFinishBtn = view.findViewById(R.id.finshBtn);

        mLinearLayout = view.findViewById(R.id.btnLinearLayout);
        ...
        mAnswerRef.child(mAuth.getCurrentUser().getUid()).child(mTest.getId())
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        for (DataSnapshot dataSnapshot1 : dataSnapshot.getChildren()) {
                            String isCorrect = dataSnapshot1.child("isCorrect").getValue().toString();
                            String selectedOption = dataSnapshot1.child("selectedOption").getValue().toString();
                        ...
                        map.put("totalQuestion", questionList.size()+"");
                        map.put("totalAnswered", mAnswerCount+"");
                        map.put("score", mScore+"");
                        map.put("id", mAuth.getCurrentUser().getUid());

                        mParticipants.child(mTest.getId()).child(mAuth.getCurrentUser().getUid())
                                .setValue(map).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    // go to AnswerDetailsFragment
                                    Bundle bundle = new Bundle();
                                    bundle.putSerializable("test", mTest);
                                    ...
                                    Toast.makeText(getContext(), "Something went wrong. Please contact with Admin.", Toast.LENGTH_SHORT).show();
                                    mProgressDialog.dismiss();
                                }
                            }
                        });
